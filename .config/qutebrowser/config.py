...
## Type: QssColor
c.colors.tabs.bar.bg = '#31363b'

## Background color of unselected even tabs.
## Type: QtColor
c.colors.tabs.even.bg = '#31363b'
...
## Type: QtColor
c.colors.tabs.selected.even.bg = '#e5e5e5'
...
## Type: QtColor
c.colors.tabs.selected.odd.bg = '#e5e5e5'
...
## Type: FontFamily
c.fonts.web.family.fixed = 'Cozette:style=Medium'

## Font family for sans-serif fonts.
## Type: FontFamily
# c.fonts.web.family.sans_serif = 'Fixed'
...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'file:///home/berzs/.home.html'
...
c.url.start_pages = ['https://discord.com/login', 'file:///home/berzs/.home.html']
...
config.bind(",p", 'spawn --userscript rand_proxy')
config.bind(",P", 'set content.proxy none')
config.bind(",d", 'hint media download')
config.bind("<Alt-b>", 'goto -t 4chan.org/bant')
config.bind("<Alt-g>", 'goto -t 4channel.org/g')
config.bind("<Alt-w>", 'goto -t 4channel.org/wsg')
config.bind("<Alt-f>", 'goto -t forums.gentoo.org')
config.bind("<Alt-d>", 'goto -t discord.com')
config.bind("<Alt-y>", 'goto -t youtube.com')
